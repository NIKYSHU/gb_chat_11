...
class ServerStorage:
    ...
    def __init__(self , path):
        ...
        # Создаём отображения
        mapper_reg = registry()
        mapper_reg.map_imperatively(self.AllUsers, users_table)
        mapper_reg.map_imperatively(self.ActiveUsers, active_users_table)
        mapper_reg.map_imperatively(self.LoginHistory, user_login_history)
        mapper_reg.map_imperatively(self.UsersContacts, contacts)
        mapper_reg.map_imperatively(self.UsersHistory, users_history_table)
